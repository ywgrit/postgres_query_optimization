...
#line 1359 "exprparse.c"
    break;

  case 3:
#line 65 "exprparse.y"
                                { (yyval.elist) = NULL; }
#line 1365 "exprparse.c"
    break;

  case 4:
#line 66 "exprparse.y"
                                                { (yyval.elist) = make_elist((yyvsp[0].expr), NULL); }
#line 1371 "exprparse.c"
    break;
